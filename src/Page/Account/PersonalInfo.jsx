...
import { fetchTourist } from "../../Redux/account/tourist/touristAccountAction";

function PersonalInfo({ touristAccountData, fetchTourist }) {

  const touristAccount = touristAccountData.touristAccount;

  const [name, setName] = useState(touristAccount.name);
  console.log("name : "+touristAccount.name);
  const [email, setEmail] = useState(touristAccount.email);
  const [phone, setPhone] = useState(touristAccount.phone);
            ...
            <div className="col-lg-7 mb-5 mb-lg-0">
              <div className="text-block">
                ...
                <p className="text-sm text-muted">
                  ...
                  {touristAccountData.touristAccount.name}
                  <br />
                  <i className="fa fa-envelope-open fa-fw me-2"></i>
                  {touristAccountData.touristAccount.email}{" "}
                  <span className="mx-2"> | </span>{" "}
                  <i className="fa fa-phone fa-fw me-2"></i>
                  {touristAccountData.touristAccount.phone}
                </p>
...
const mapStateToProps = (state) => {
  return {
    touristAccountData: state.touristAccount,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    fetchTourist: () => dispatch(fetchTourist()),
  };
};
