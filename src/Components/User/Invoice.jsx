        ...
        <div className="row mb-4 d-print-none">
          <div className="col-lg-6">
            ...
            <ol className="breadcrumb ps-0  justify-content-start">
              ...
              <li className="breadcrumb-item active">Invoice 202009001   </li>
            </ol>
          </div>
          <div className="col-lg-6 text-lg-end">
            <button className="btn btn-primary me-2"><i className="far fa-file-pdf me-2"></i> Download PDF</button>
            <button className="btn" onclick="window.print()"><i className="fas fa-print me-2"></i> Print</button>
          </div>
        </div>
        <div className="card border-0 shadow shadow-print-0">
          <div className="card-header bg-gray-100 p-5 border-0 px-print-0">
            <div className="row">
              <div className="col-6 d-flex align-items-center"><img src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/logo.svg" alt="Directory"/></div>
          ...
          <div className="card-body p-5 p-print-0">
            ...
            <div className="row mb-5">
              <div className="col-md-6 pe-lg-3 text-sm">
                <div className="row">
                  <div className="col-6 text-uppercase text-muted">Bank account</div>
                  <div className="col-6 text-end">hello@bootstrapious.com</div>
                </div>
                <div className="row">
                  <div className="col-6 text-uppercase text-muted">Reference</div>
                  <div className="col-6 text-end">202009001</div>
                </div>
                <div className="row">
                  <div className="col-6 text-uppercase text-muted">Payment method</div>
                  <div className="col-6 text-end">Bank transfer</div>
                </div>
              </div>
              <div className="col-md-6 ps-lg-4 text-sm">
                <div className="row">
                  <div className="col-6 text-uppercase text-muted">Issued on</div>
