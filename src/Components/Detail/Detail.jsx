...
function Detail() {
    return(
        ...
        <br />
        <br />
        <section className="pt-7 pb-5 d-flex align-items-end dark-overlay bg-cover" style={{backgroundImage: `url("https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1515164783716-8e6920f3e77c.jpg")`}}>
      <div className="container overlay-content">
        <div className="d-flex justify-content-between align-items-start flex-column flex-lg-row align-items-lg-end">
          <div className="text-white mb-4 mb-lg-0">
            ...
            <p><i className="fa-map-marker-alt fas me-2"></i> 53 Broadway, Brooklyn, NY 1129</p>
            <p className="mb-0 d-flex align-items-center"><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-gray-200 me-4">                   </i>8 Reviews</p>
          </div>
          ...
          <div className="col-lg-8">
            ...
            <div className="text-block">
              ...
              <div className="row gallery ms-n1 me-n1">
                <div className="col-lg-4 col-6 px-1 mb-2"><a href="img/photo/restaurant-1515164783716-8e6920f3e77c.jpg"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1515164783716-8e6920f3e77c.jpg" alt="..."/></a></div>
                <div className="col-lg-4 col-6 px-1 mb-2"><a href="img/photo/restaurant-1466978913421-dad2ebd01d17.jpg"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1466978913421-dad2ebd01d17.jpg" alt="..."/></a></div>
                <div className="col-lg-4 col-6 px-1 mb-2"><a href="img/photo/restaurant-1477763858572-cda7deaa9bc5.jpg"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1477763858572-cda7deaa9bc5.jpg" alt="..."/></a></div>
                <div className="col-lg-4 col-6 px-1 mb-2"><a href="img/photo/restaurant-1505275350441-83dcda8eeef5.jpg"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1505275350441-83dcda8eeef5.jpg" alt="..."/></a></div>
                <div className="col-lg-4 col-6 px-1 mb-2"><a href="img/photo/restaurant-1508766917616-d22f3f1eea14.jpg"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1508766917616-d22f3f1eea14.jpg" alt="..."/></a></div>
                <div className="col-lg-4 col-6 px-1 mb-2"><a href="img/photo/restaurant-1430931071372-38127bd472b8.jpg"><img className="img-fluid" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1430931071372-38127bd472b8.jpg" alt="..."/></a></div>
              </div>
            </div>
            {/* <!-- Amenities--> */}
            <div className="text-block">
              ...
              <ul className="amenities-list list-inline">
                <li className="list-inline-item mb-3">
                  <div className="d-flex align-items-center">
                    <div className="icon-circle bg-secondary me-2"><i className="fa fa-check"></i></div><span>Elevator</span>
                  </div>
                </li>
                <li className="list-inline-item mb-3">
                  <div className="d-flex align-items-center">
                    <div className="icon-circle bg-secondary me-2"><i className="fa fa-check"></i></div><span>Vegan friendly</span>
                  </div>
                </li>
                <li className="list-inline-item mb-3">
                  <div className="d-flex align-items-center">
                    <div className="icon-circle bg-secondary me-2"><i className="fa fa-check"></i></div><span>Alcohol served</span>
                  </div>
                </li>
                <li className="list-inline-item mb-3">
                  <div className="d-flex align-items-center">
                    <div className="icon-circle bg-secondary me-2"><i className="fa fa-check"></i></div><span>No smoking</span>
                  </div>
                </li>
                <li className="list-inline-item mb-3">
                  <div className="d-flex align-items-center">
                    <div className="icon-circle bg-secondary me-2"><i className="fa fa-check"></i></div><span>Parking spaces (paid)</span>
                  </div>
                </li>
                <li className="list-inline-item mb-3">
                  <div className="d-flex align-items-center">
                    <div className="icon-circle bg-secondary me-2"><i className="fa fa-check"></i></div><span>WiFi</span>
                  </div>
                </li>
              </ul>
            </div>
            <div className="text-block">
              ...
              <div className="d-flex d-block d-sm-flex review">
                <div className="text-md-center flex-shrink-0 me-4 me-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/avatar/avatar-8.jpg" alt="Padmé Amidala"/><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div>
                  <h6 className="mt-2 mb-1">Padmé Amidala</h6>
                  <div className="mb-2"><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i>
                  </div>
                  <p className="text-muted text-sm">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections     </p>
                </div>
              </div>
              <div className="d-flex d-block d-sm-flex review">
                <div className="text-md-center flex-shrink-0 me-4 me-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/avatar/avatar-2.jpg" alt="Luke Skywalker"/><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div>
                  <h6 className="mt-2 mb-1">Luke Skywalker</h6>
                  <div className="mb-2"><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-gray-200"></i>
                  </div>
              ...
              <div className="d-flex d-block d-sm-flex review">
                <div className="text-md-center flex-shrink-0 me-4 me-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/avatar/avatar-3.jpg" alt="Princess Leia"/><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div>
                  <h6 className="mt-2 mb-1">Princess Leia</h6>
                  <div className="mb-2"><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-primary"></i><i className="fa fa-xs fa-star text-gray-200"></i><i className="fa fa-xs fa-star text-gray-200"></i>
                  </div>
              ...
              <div className="d-flex d-block d-sm-flex review">
                <div className="text-md-center flex-shrink-0 me-4 me-xl-5"><img className="d-block avatar avatar-xl p-2 mb-2" src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/avatar/avatar-4.jpg" alt="Jabba Hut"/><span className="text-uppercase text-muted text-sm">Dec 2018</span></div>
                <div>
              ...
              <div className="py-5">
                <button className="btn btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#leaveReview" aria-expanded="false" aria-controls="leaveReview">Leave a review</button>
                <div className="collapse mt-4" id="leaveReview">
                  ...
                  <form className="form" id="contact-form" method="get" action="#">
                    <div className="row">
                      ...
                      <div className="col-sm-6">
                        <div className="mb-4">
                          <label className="form-label" for="rating">Your rating *</label>
                          <select className="form-select focus-shadow-0" name="rating" id="rating">
                    ...
                    <div className="mb-4">
                      <label className="form-label" for="review">Review text *</label>
              ...
              <div className="card border-0 shadow mb-5">
                ...
                <div className="card-body">
                  <ul className="list-unstyled mb-4">
                    <li className="mb-2"> <a className="text-gray-00 text-sm text-decoration-none" href="#"><i className="fa fa-phone me-3"></i><span className="text-muted">(020) 123 456 789</span></a></li>
                    <li className="mb-2"> <a className=" text-sm text-decoration-none" href="#"><i className="fa fa-envelope me-3"></i><span className="text-muted">info@example.com</span></a></li>
                    <li className="mb-2"> <a className=" text-sm text-decoration-none" href="#"><i className="fa fa-globe me-3"></i><span className="text-muted">www.example.com</span></a></li>
                    <li className="mb-2"> <a className="text-blue text-sm text-decoration-none" href="#"><i className="fab fa-facebook me-3"></i><span className="text-muted">Facebook</span></a></li>
                    <li className="mb-2"> <a className=" text-sm text-decoration-none" href="#"><i className="fab fa-twitter me-3"></i><span className="text-muted">Twitter</span></a></li>
                    <li className="mb-2"> <a className=" text-sm text-decoration-none" href="#"><i className="fab fa-instagram me-3"></i><span className="text-muted">Instagram</span></a></li>
                    <li className="mb-2"> <a className=" text-sm text-decoration-none" href="#"><i className="fab fa-google-plus me-3"></i><span className="text-muted">Google+</span></a></li>
                  </ul>
                  <div className="d-grid text-center"><a className="btn btn-outline-primary" href="#"> <i className="far fa-paper-plane me-2"></i>Send a Message</a></div>
                </div>
              </div>
