            ...
            <div className="row">
              <div className="col-xl-4 col-md-6 mb-4">
                ...
                <div className="input-label-absolute input-label-absolute-right">
                  ...
                  <input className="form-control pe-4" type="search" name="search" placeholder="Keywords" id="form_search"/>
                </div>
              </div>
              <div className="col-xl-4 col-md-6 mb-4">
                <label className="form-label" for="form_neighbourhood">Neighbourhood</label>
                <select className="selectpicker form-control" name="neighbourhood" id="form_neighbourhood" multiple data-style="btn-selectpicker" data-live-search="true" data-selected-text-format="count &gt; 1" data-none-selected-text="">
              ...
              <div className="col-xl-4 col-md-6 mb-4">
                <label className="form-label" for="form_category">Category</label>
                <select className="selectpicker form-control" name="category" id="form_category" multiple data-style="btn-selectpicker" data-selected-text-format="count &gt; 1" data-none-selected-text="">
          ...
          <div className="row">
            ...
            <div className="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
              <div className="card h-100 border-0 shadow">
                <div className="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(../../../d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1430931071372-38127bd472b8.jpg); min-height: 200px;"><a className="tile-link" href="detail.html"></a>
            ...
            <div className="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e322f3375db4d89128">
              <div className="card h-100 border-0 shadow">
                <div className="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(../../../d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1436018626274-89acd1d6ec9d.jpg); min-height: 200px;"><a className="tile-link" href="detail.html"></a>
                  <div className="card-img-overlay-bottom z-index-20">
            ...
            <div className="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e3a31e62979bf147c9">
              <div className="card h-100 border-0 shadow">
                <div className="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(../../../d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1466978913421-dad2ebd01d17.jpg); min-height: 200px;"><a className="tile-link" href="detail.html"></a>
                  <div className="card-img-overlay-bottom z-index-20">
            ...
            <div className="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e3503eb77d487e8082">
              <div className="card h-100 border-0 shadow">
                <div className="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(../../../d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1477763858572-cda7deaa9bc5.jpg); min-height: 200px;"><a className="tile-link" href="detail.html"></a>
                  <div className="card-img-overlay-bottom z-index-20">
            ...
            <div className="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e39aa2eed0626e485d">
              <div className="card h-100 border-0 shadow">
                <div className="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(../../../d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1504087697492-238a6bf49ce8.jpg); min-height: 200px;"><a className="tile-link" href="detail.html"></a>
                  <div className="card-img-overlay-bottom z-index-20">
            ...
            <div className="col-sm-6 mb-5 hover-animate" data-marker-id="59c0c8e39aa2edasd626e485d">
              <div className="card h-100 border-0 shadow">
                <div className="card-img-top overflow-hidden dark-overlay bg-cover" style="background-image: url(../../../d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/restaurant-1505275350441-83dcda8eeef5.jpg); min-height: 200px;"><a className="tile-link" href="detail.html"></a>
                  <div className="card-img-overlay-bottom z-index-20">
