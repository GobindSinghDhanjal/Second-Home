    ...
    <div>
        ...
        <div className="row min-vh-100">
            ...
            <div className="w-100 py-5 px-md-5 px-xxl-6 position-relative">
              <div className="mb-5">
                <img
                  ...
                  src="https://d19m59y37dris4.cloudfront.net/directory/2-0/img/logo-square.svg"
                  alt="..."
                  style={{ maxWidth: "4rem" }}
                />
                <h2>Welcome back</h2>
          ...
          <div className="col-md-4 col-lg-6 col-xl-7 d-none d-md-block">
            ...
            <div
              ...
              style={{
                backgroundImage: `url("https://d19m59y37dris4.cloudfront.net/directory/2-0/img/photo/photo-1497436072909-60f360e1d4b1.jpg")`,
              }}
            ></div>
          </div>
        </div>
      ...
      <div className="collapse" id="style-switch">
        <div className="p-4">
          ...
          <form className="mb-3">
            <select
              className="form-select style-switch-select"
              name="colour"
              id="colour"
            >
